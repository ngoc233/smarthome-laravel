        ...
        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 agile-last-left agile-last-right">
          <div class="agile-last-grid">
            <div class="area-grids-heading">
              <h3>Thống kê độ khô của đất <span style="color: #00bcd4">{{$start}} - {{$end}}</span></h3>
            </div>
            <div id="graph9"></div>
  ...
  <script type="text/javascript">
    $(document).ready(function()
    {
      $("#find-time").click(function()
      {
        ...
        var end_time = $("#to").val();
        window.location.href = "http://localhost:8888/smarthome/public/landhumidity?start_time="+start_time+"&end_time="+end_time;
      });
    });
  </script>
@stop
